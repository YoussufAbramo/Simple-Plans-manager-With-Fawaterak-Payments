...
<div class="qaff-portal-wrapper" style="max-width: 1000px; margin: 0 auto; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif;">
    ...
    <?php if (isset($_GET['payment_pending'])): ?>
        <div style="background: #feebc8; color: #744210; padding: 15px; border-radius: 8px; border: 1px solid #f6ad55; margin-bottom: 25px; font-weight: 500;">
            ? <strong>Payment Pending.</strong> Your payment for order #<?php echo esc_html(intval($_GET['order_id'] ?? 0)); ?> is currently processing. Your subscription will activate once payment is confirmed.
        </div>
    <?php endif; ?>
